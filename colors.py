#display for all the named colors you can use in pygame, along with their RGB values
#all the names starting with 'gray' can be spelled 'grey' as well, 
    #I just deleted them so there not a ton of duplicates/spam
import sys
import pygame
...
def main():
    ...
    for cname in sortedcolors:
        ...
        if p[0] >= SCREEN_WIDTH-w-2*os:
            print("Off the right of the screen")
    ...
    while playing:
        ...
        for c in clist:
            ...
            # modified from https://stackoverflow.com/questions/1855884/determine-font-color-based-on-background-color
            d = 0
